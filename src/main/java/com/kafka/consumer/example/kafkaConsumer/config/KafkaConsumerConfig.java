...
public class KafkaConsumerConfig {
	 ...
	 */
	public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String,String>> factoty(ConsumerFactory<String, String> consumerFactory){
